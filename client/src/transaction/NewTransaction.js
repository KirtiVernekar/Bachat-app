...
import { Card, CardActions, CardContent, Button, Icon, TextField, Typography } from '@material-ui/core'
import auth from '../auth/auth-helper'
import { makeStyles } from '@material-ui/core/styles'
import {create} from './api-transaction.js'
...
const NewTransaction = () => {
  ...
  const {typeOfTransaction} = useContext(GlobalContext);
  ...
  const clickSubmit = () => {
    const transaction = {
        ...
        transactionType: typeOfTransaction.toLowerCase() || undefined,
